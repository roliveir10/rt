...
/*   Updated: 2019/07/03 01:14:26 by oboutrol         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		pars_select_field(t_token **token, t_form *form, t_env *env)
{
	...
	static char		*names[NB_FIELDS] = {
		...
		"\"texture\"", "\"atexture\"", "\"recurrence\"", "\"reflection\"",
		"\"transp\"", "\"density\""};
	static void		*(*fct_set[NB_FIELDS])(t_form*, t_token**) = {
		...
		set_recurrence_form, set_recurrence_form, set_reflection_form,
		set_transp_form, set_density_form};
